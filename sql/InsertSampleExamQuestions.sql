...
-- ================================================================
-- This script creates 3 biology/physics questions for testing the
-- written answer evaluation pipeline.
-- ================================================================

USE [smartstudydb];
GO

-- Clean up existing questions for this exam (if any)
DELETE FROM ExamQuestions WHERE ExamId = 'SAMPLE-EXAM-001';
GO

-- Insert Question 1: Photosynthesis (20 points)
...
-- Insert Question 2: Newton's Laws (15 points)
INSERT INTO ExamQuestions (
    Id,
    ExamId,
    QuestionNumber,
...
-- Insert Question 3: Water Cycle (15 points)
INSERT INTO ExamQuestions (
    Id,
    ExamId,
    QuestionNumber,
...
SELECT 
    QuestionNumber,
    SUBSTRING(QuestionText, 1, 50) + '...' AS QuestionPreview,
    MaxScore,
    ClassName,
    Subject,
    Chapter
FROM ExamQuestions
WHERE ExamId = 'SAMPLE-EXAM-001'
ORDER BY QuestionNumber;

GO

PRINT '✓ Successfully inserted 3 questions for SAMPLE-EXAM-001';
PRINT '  Question 1: Photosynthesis (20 points)';
PRINT '  Question 2: Newton''s First Law (15 points)';
PRINT '  Question 3: Water Cycle (15 points)';
PRINT '  Total: 50 points';
GO
